...
pipe = rs.pipeline()
cfg = rs.config()
cfg.enable_device_from_file("/HOMES/yigao/Documents/Below_knee/go_upstairs/1/20240119_153114.bag", repeat_playback=False)
profile = pipe.start(cfg)
playback = profile.get_device().as_playback()
playback.set_real_time(False)

# set the output directory
output_depth = "/HOMES/yigao/Documents/Below_knee/go_upstairs/1/depth_tiff/"
output_depth_png = "/HOMES/yigao/Documents/Below_knee/go_upstairs/1/depth_png/"
output_color = "/HOMES/yigao/Documents/Below_knee/go_upstairs/1/rgb/"

output_depth_th = "/HOMES/yigao/Documents/Below_knee/go_upstairs/1/depth_threshold/"
output_color_th = "/HOMES/yigao/Documents/Below_knee/go_upstairs/1/rgb_threshold/"
...
try:
    while (time.time() - start_time) < 5000:
        ...
        # coopy to the threshold folders
        # cv2.imwrite(output_depth_th + "depth_" + "%#05d" % (count + 1) + ".tiff", colorized_depth)
        # plt.imsave(output_color_th + "color_" + "%#05d" % (count + 1) + ".jpg", colorized_color)
