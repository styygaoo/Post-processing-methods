...
output_depth = "/HOMES/yigao/Documents/Below_knee/go_upstairs/5/depth/"
...
try:
    while (time.time() - start_time) < 5000:
        ...
        # save depth maps and rgb images
        # plt.imsave(output_depth + "depth_" + "%#05d" % (count + 1) + ".png", colorized_depth)
